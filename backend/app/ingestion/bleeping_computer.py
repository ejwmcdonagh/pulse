"""
Bleeping Computer RSS ingester.

Source: https://www.bleepingcomputer.com
Feed:   https://www.bleepingcomputer.com/feed/

Bleeping Computer consistently breaks threat stories 24-48 hours before
official CISA advisories appear. It is one of the highest signal-to-noise
cybersecurity news sources available publicly.

Combined with an NVD or CISA signal on the same topic, a Bleeping Computer
article is strong evidence that a threat is actively developing.
"""
...
class BleepingComputerIngester(BaseIngester):
    source = SignalSource.BLEEPING_COMPUTER
